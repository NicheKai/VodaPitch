...
<div style="text-align: center; margin: 6px 0; padding: 6px; background: linear-gradient(to bottom, #f9f9f9, #f0f0f0); border-radius: 4px; font-size: 11px; border: 1px solid #e8e8e8;"><span style="color: #000; font-weight: bold; font-size: 13px;">Only &pound;[CtotalMonthly]/mo</span><br /><span style="font-size: 10px; color: #666;">&pound;[CupfrontCost] upfront &bull; &pound;6.99 Delivery</span></div>
